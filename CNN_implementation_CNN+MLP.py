...
# process_and_train(adolescent_df, label_column='Class/ASD', dataset_name="Adolescent Dataset", epochs=100, lr=0.005)
# process_and_train(adult_df, label_column='Class/ASD', dataset_name="Adult Dataset", epochs=50)
# process_and_train(child_df, label_column='Class/ASD', dataset_name="Child Dataset", epochs=80, lr=0.005)

# Combine all datasets and train
combined_df = combine_datasets(adolescent_df, adult_df, child_df)
process_and_train(combined_df, label_column='Class/ASD', dataset_name="Combined Dataset", epochs=25, lr=0.005)
