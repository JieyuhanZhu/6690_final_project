...
class SimplestCNN1D(nn.Module):
    def __init__(self, input_size, num_classes):
        ...
        self.relu = nn.ReLU()
        self.conv2 = nn.Conv1d(in_channels=4, out_channels=num_classes, kernel_size=1)
...
# process_and_train(child_df, label_column='Class/ASD', dataset_name="Child Dataset", epochs=800, lr=0.005)
